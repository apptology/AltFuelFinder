...
_L3:
    ...
    {
        return (new StringBuilder()).append("OAuth2Authorization{consumerKey='").append(consumerKey).append('\'').append(", consumerSecret='******************************************'").append(", token=").append(token.toString()).append('}').toString();
    }
}
