    ...
    implements android.widget.er
{
    ...
    public boolean onEditorAction(TextView textview, int i, KeyEvent keyevent)
    {
        ...
        if (i != 0)
        {
            if (!StringUtils.isNotEmpty(MortgageCalculatorFragment.access$000(MortgageCalculatorFragment.this).getText().toString()));
            MortgageCalculatorFragment.access$100(MortgageCalculatorFragment.this).requestFocus();
        }
        return true;
    }
