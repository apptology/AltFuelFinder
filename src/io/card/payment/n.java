...
class n extends View
{
    ...
    private static final String a = io/card/payment/n.getSimpleName();
    ...
    public n(CardIOActivity cardioactivity, AttributeSet attributeset, boolean flag)
    {
    ...
    public final void a(Rect rect, int i1)
    {
        ...
        if (p != null)
        {
            ...
            s = io.card.payment.q.a(new Point(p.left + ((Point) (rect)).x, p.top + ((Point) (rect)).y), (int)(70F * w), (int)(w * 50F));
            i1 = p.right;
            int j1 = ((Point) (rect)).x;
            int k1 = p.top;
            t = io.card.payment.q.a(new Point(i1 - j1, ((Point) (rect)).y + k1), (int)(100F * w), (int)(w * 50F));
