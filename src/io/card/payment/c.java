...
//            CardIOActivity, DataEntryActivity, n
    ...
    implements Runnable
{
    ...
    public final void run()
    {
        ...
        if (CardIOActivity.a(a) != null)
        {
            ...
            if (CardIOActivity.a != null && !CardIOActivity.a.isRecycled())
            {
                CardIOActivity.a.recycle();
            }
            CardIOActivity.a = CardIOActivity.a(a).b();
        }
        ...
        a.startActivityForResult(intent, CardIOActivity.d());
    }
}
