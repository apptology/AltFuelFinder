...
class this._cls0
    implements android.view.ailFragment._cls4
{
    ...
    {
        int _tmp = HoleDetailFragment.access$408(HoleDetailFragment.this);
        boolean flag;
        if (HoleDetailFragment.access$400(HoleDetailFragment.this) <= HoleDetailFragment.access$600(HoleDetailFragment.this).getHoleList().size())
        {
            flag = true;
        } else
        {
