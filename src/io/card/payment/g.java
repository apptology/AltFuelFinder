...
class g
{
    ...
    public static String a(String s, boolean flag, CardType cardtype)
    {
        String s1;
        CardType cardtype1;
        int i;
    ...
    public static Date a(String s)
    {
        ...
        if (i == 4)
        {
            s = new SimpleDateFormat("MMyy");
        } else
        if (i == 6)
        {
            s = new SimpleDateFormat("MMyyyy");
        } else
        {
            s = null;
        }
