...
.field private b:Lcom/paypal/android/sdk/payments/i;
...
.method public constructor <init>(Lcom/paypal/android/sdk/payments/PayPalService;)V
    ...
    iput-object v0, p0, Lcom/paypal/android/sdk/payments/d;->a:Lcom/paypal/android/sdk/payments/j;

    new-instance v0, Lcom/paypal/android/sdk/payments/i;

    invoke-direct {v0, p1}, Lcom/paypal/android/sdk/payments/i;-><init>(Lcom/paypal/android/sdk/payments/PayPalService;)V

    iput-object v0, p0, Lcom/paypal/android/sdk/payments/d;->b:Lcom/paypal/android/sdk/payments/i;

    return-void
.end method

.method static a(Landroid/app/Activity;Lcom/paypal/android/sdk/cG;Lcom/paypal/android/sdk/cG;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog;
    .locals 3
    ...
    invoke-static {p1}, Lcom/paypal/android/sdk/cE;->a(Lcom/paypal/android/sdk/cG;)Ljava/lang/String;
    ...
    invoke-static {p2}, Lcom/paypal/android/sdk/cE;->a(Lcom/paypal/android/sdk/cG;)Ljava/lang/String;
    ...
    sget-object v1, Lcom/paypal/android/sdk/cG;->f:Lcom/paypal/android/sdk/cG;
...
.method private static a(Landroid/content/Context;Lcom/paypal/android/sdk/cG;Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog;
    .locals 4
...
.method static a(Landroid/app/Activity;Lcom/paypal/android/sdk/cG;Landroid/os/Bundle;)Landroid/app/Dialog;
    .locals 2
    ...
    invoke-static {p0, p1, v0, v1}, Lcom/paypal/android/sdk/payments/d;->a(Landroid/content/Context;Lcom/paypal/android/sdk/cG;Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog;
...
.method static a(Landroid/app/Activity;Lcom/paypal/android/sdk/cG;Landroid/os/Bundle;I)Landroid/app/Dialog;
    .locals 2
...
.method static a(Landroid/app/Activity;Lcom/paypal/android/sdk/cG;Landroid/os/Bundle;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/Dialog;
    .locals 1
    ...
    invoke-static {p0, p1, v0, p3}, Lcom/paypal/android/sdk/payments/d;->a(Landroid/content/Context;Lcom/paypal/android/sdk/cG;Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog;
...
.method static a(Landroid/content/Context;Lcom/paypal/android/sdk/cG;Lcom/paypal/android/sdk/cG;)Landroid/app/Dialog;
    .locals 2
...
.method public static a(Lcom/paypal/android/sdk/br;)Ljava/lang/Object;
    .locals 6

    instance-of v0, p0, Lcom/paypal/android/sdk/ch;

    if-eqz v0, :cond_0

    check-cast p0, Lcom/paypal/android/sdk/ch;

    new-instance v0, Lcom/paypal/android/sdk/payments/ProofOfPayment;

    invoke-virtual {p0}, Lcom/paypal/android/sdk/ch;->w()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0}, Lcom/paypal/android/sdk/ch;->u()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p0}, Lcom/paypal/android/sdk/ch;->x()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {p0}, Lcom/paypal/android/sdk/ch;->y()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {p0}, Lcom/paypal/android/sdk/ch;->z()Ljava/lang/String;
    ...
    :cond_0
    instance-of v0, p0, Lcom/paypal/android/sdk/cl;

    if-eqz v0, :cond_1

    check-cast p0, Lcom/paypal/android/sdk/cl;

    new-instance v0, Lcom/paypal/android/sdk/payments/ProofOfPayment;

    invoke-virtual {p0}, Lcom/paypal/android/sdk/cl;->D()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0}, Lcom/paypal/android/sdk/cl;->E()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p0}, Lcom/paypal/android/sdk/cl;->G()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {p0}, Lcom/paypal/android/sdk/cl;->F()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {p0}, Lcom/paypal/android/sdk/cl;->H()Ljava/lang/String;
...
.method static a(Landroid/app/Activity;Landroid/widget/TextView;Lcom/paypal/android/sdk/cG;)V
    .locals 4
    ...
    invoke-static {v1, p0, v2}, Lcom/paypal/android/sdk/bu;->a(Ljava/lang/String;Landroid/content/Context;I)Landroid/graphics/Bitmap;
...
.method static a(Landroid/app/Activity;Lcom/paypal/android/sdk/payments/aI;III)V
    .locals 4
    ...
    iget-object v2, p1, Lcom/paypal/android/sdk/payments/aI;->a:Ljava/lang/Integer;
    ...
    iget-object v3, p1, Lcom/paypal/android/sdk/payments/aI;->b:Ljava/lang/String;
    ...
    sget-object v0, Lcom/paypal/android/sdk/cG;->bd:Lcom/paypal/android/sdk/cG;
    ...
    :cond_5
    sget-object v0, Lcom/paypal/android/sdk/cG;->bb:Lcom/paypal/android/sdk/cG;
...
.method static a(Landroid/widget/TextView;Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lcom/paypal/android/sdk/aw;->c(Ljava/lang/String;)Z
    ...
    :cond_2
    invoke-static {p1}, Lcom/paypal/android/sdk/aw;->b(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_3

    sget-object v0, Lcom/paypal/android/sdk/cG;->ag:Lcom/paypal/android/sdk/cG;
    ...
    :cond_3
    invoke-static {p1}, Lcom/paypal/android/sdk/aw;->a(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_4

    sget-object v0, Lcom/paypal/android/sdk/cG;->af:Lcom/paypal/android/sdk/cG;
...
# virtual methods
.method public a(Lcom/paypal/android/sdk/cD;ZLjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .locals 6

    iget-object v0, p0, Lcom/paypal/android/sdk/payments/d;->a:Lcom/paypal/android/sdk/payments/j;
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/paypal/android/sdk/payments/j;->a(Lcom/paypal/android/sdk/cD;ZLjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lcom/paypal/android/sdk/payments/d;->b:Lcom/paypal/android/sdk/payments/i;
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/paypal/android/sdk/payments/i;->a(Lcom/paypal/android/sdk/cD;ZLjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
