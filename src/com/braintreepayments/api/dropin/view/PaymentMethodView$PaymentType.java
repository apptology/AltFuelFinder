...
public static final class mCanonicalName extends Enum
{
    ...
    static 
    {
        ...
        ANDROID_PAY = new <init>("ANDROID_PAY", 8, com.braintreepayments.api.dropin.Type, com.braintreepayments.api.dropin._pay, "Google Wallet");
        UNKNOWN = new <init>("UNKNOWN", 9, -1, com.braintreepayments.api.dropin., "unknown");
        $VALUES = (new .VALUES[] {
