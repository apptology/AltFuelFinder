...
class o extends ViewGroup
{
    ...
    private static final String b = io/card/payment/o.getSimpleName();
    private int c;
    private int d;
    private SurfaceView e;

    public o(Context context, AttributeSet attributeset, int i, int j)
    {
        super(context, null);
        c = 480;
        d = 640;
...
label0:
    ...
    {
        boolean flag;
        if (!io/card/payment/o.desiredAssertionStatus())
        {
            flag = true;
        } else
        {
