    ...
    implements UncaughtExceptionHandler
{
    ...
    {
        if (CrashReporter.access$500(CrashReporter.this) != null)
        {
            CrashReporter.access$100(CrashReporter.this).debug((new StringBuilder()).append("Chaining crash reporting duties to ").append(CrashReporter.access$500(CrashReporter.this).getClass().getSimpleName()).toString());
            CrashReporter.access$500(CrashReporter.this).uncaughtException(thread, throwable);
        }
    }
    ...
    public void uncaughtException(Thread thread, Throwable throwable)
    {
        ...
        CrashReporter.access$300(CrashReporter.this).store(((Crash) (obj)));
        reportCrash(((Crash) (obj)));
        CrashReporter.access$400().shutdown();
        if (!CrashReporter.access$400().awaitTermination(5000L, TimeUnit.MILLISECONDS))
        {
