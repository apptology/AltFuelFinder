    ...
    implements Writer
{
    ...
    public BitMatrix encode(String s, BarcodeFormat barcodeformat, int i, int j, Map map)
    {
        ...
        s = HighLevelEncoder.encodeHighLevel(s, barcodeformat1, ((Dimension) (obj1)), map1);
        barcodeformat = SymbolInfo.lookup(s.length(), barcodeformat1, ((Dimension) (obj1)), map1, true);
