...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lio/card/payment/g;->a:Landroid/graphics/Paint;

    iget-object v0, p0, Lio/card/payment/g;->a:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, Lio/card/payment/g;->b:Landroid/graphics/Bitmap;

    iput-object p1, p0, Lio/card/payment/g;->d:Landroid/content/Context;
...
.method public static a(Ljava/lang/String;ZLio/card/payment/CardType;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lio/card/payment/g;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lio/card/payment/g;->c(Ljava/lang/String;)Ljava/lang/String;
...
.method public a(Landroid/graphics/Canvas;FF)V
    ...
    iget-object v0, p0, Lio/card/payment/g;->b:Landroid/graphics/Bitmap;

    if-nez v0, :cond_0

    invoke-virtual {p0, v6}, Lio/card/payment/g;->a(Z)V
    ...
    iget-object v1, p0, Lio/card/payment/g;->b:Landroid/graphics/Bitmap;
    ...
    iget-object v2, p0, Lio/card/payment/g;->b:Landroid/graphics/Bitmap;

    new-instance v3, Landroid/graphics/Rect;

    iget-object v4, p0, Lio/card/payment/g;->b:Landroid/graphics/Bitmap;

    invoke-virtual {v4}, Landroid/graphics/Bitmap;->getWidth()I

    move-result v4

    iget-object v5, p0, Lio/card/payment/g;->b:Landroid/graphics/Bitmap;
...
.method a(Z)V
    ...
    iget-boolean v0, p0, Lio/card/payment/g;->c:Z
    ...
    :cond_0
    iput-boolean p1, p0, Lio/card/payment/g;->c:Z
    ...
    iget-object v1, p0, Lio/card/payment/g;->d:Landroid/content/Context;

    invoke-static {v0, v1, v2}, Lcom/paypal/android/sdk/dK;->a(Ljava/lang/String;Landroid/content/Context;I)Landroid/graphics/Bitmap;
