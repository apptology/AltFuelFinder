...
_L1:
        ...
        ai[1] = 0;
        ai[2] = 0;
        for (i = i1; i < k1 && !image.get(i, j2); i++) { }
        boolean flag = false;
        l = i;
        i = ((flag) ? 1 : 0);
_L9:
...
_L3:
        if (!image.get(l, j2)) goto _L6; else goto _L5
_L5:
...
_L12:
        AlignmentPattern alignmentpattern = handlePossibleCenter(ai, j2, l);
...
_L4:
        ...
        alignmentpattern1 = handlePossibleCenter(ai, j2, k1);
        alignmentpattern = alignmentpattern1;
