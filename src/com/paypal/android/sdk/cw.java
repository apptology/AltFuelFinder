...
public class cw extends br
{
    ...
    private static final String a = com/paypal/android/sdk/cw.getSimpleName();
    private final aB b;

    public cw(bs bs1, c c1, aB ab)
    {
        super(new bw(bx.a), bs1, c1);
        b = ab;
    }
    ...
    public final String b()
    {
        ...
        stringbuilder.append("s").append(b.a).append("?AQB=1").append("&ndh=1").append((new StringBuilder("&t")).append(com.paypal.android.sdk.d.a(((String) (obj)))).toString());
