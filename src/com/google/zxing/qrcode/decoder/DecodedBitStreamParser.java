...
_L6:
        ...
        return new DecoderResult(abyte0, map, version, errorcorrectionlevel, i, j);
_L2:
...
_L9:
        ...
        k = bitsource.readBits(4);
        l = bitsource.readBits(mode.getCharacterCountBits(version));
        characterseteci1 = characterseteci;
        i = byte1;
        j = byte0;
        flag1 = flag;
        if (k != 1) goto _L4; else goto _L10
_L10:
        decodeHanziSegment(bitsource, stringbuilder, l);
        characterseteci1 = characterseteci;
        i = byte1;
        j = byte0;
        flag1 = flag;
