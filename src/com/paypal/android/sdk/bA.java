...
_L1:
        ...
        if (d.a(((CharSequence) (obj1))))
        {
            obj1 = null;
        } else
        {
            obj1 = bD.valueOf(((String) (obj1)));
        }
        obj1 = new bB(s, ((ce) (obj)), ((bD) (obj1)));
        obj = obj2;
        if (((bB) (obj1)).d())
        {
            obj = obj1;
    ...
    {
        boolean flag;
        if (!com/paypal/android/sdk/bA.desiredAssertionStatus())
        {
            flag = true;
        } else
        {
