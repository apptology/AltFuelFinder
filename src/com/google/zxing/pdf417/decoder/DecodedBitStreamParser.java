...
final class DecodedBitStreamParser
{
    ...
    private static int byteCompaction(int i, int ai[], Charset charset, int j, StringBuilder stringbuilder)
    {
...
_L2:
        i = textCompaction(ai, j, stringbuilder);
          goto _L12
_L3:
        i = byteCompaction(i, ai, charset, j, stringbuilder);
          goto _L12
_L5:
        stringbuilder.append((char)ai[j]);
        i = j + 1;
          goto _L12
_L4:
        i = numericCompaction(ai, j, stringbuilder);
          goto _L12
_L9:
        charset = Charset.forName(CharacterSetECI.getCharacterSetECIByValue(ai[j]).name());
        i = j + 1;
          goto _L12
_L8:
        i = j + 2;
