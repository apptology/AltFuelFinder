    ...
    implements k
{
    ...
    public p()
    {
        a.put(cG.a, "Agree and Pay");
        a.put(cG.b, "& other");
        a.put(cG.c, "Authenticating");
        a.put(cG.d, "Back");
        a.put(cG.e, "Backup");
        a.put(cG.f, "Cancel");
        ...
        a.put(cG.v, "Visa");
        a.put(cG.w, "Change Payment Method");
        a.put(cG.x, "Cheque");
        a.put(cG.y, "Checking this device\u2026");
        a.put(cG.z, "Clear card information");
        a.put(cG.A, "Confirm");
        a.put(cG.B, "Are you sure you want to clear your card information?");
        a.put(cG.C, "Charge Card");
        a.put(cG.D, "Are you sure you want to log out of PayPal?");
        a.put(cG.E, "Pay");
        a.put(cG.F, "Agree");
        a.put(cG.G, "Account Creation Date");
        a.put(cG.H, "Account Status");
        a.put(cG.I, "Account Type");
        a.put(cG.J, "Address");
        a.put(cG.K, "Age Range");
        a.put(cG.L, "Date of Birth");
        a.put(cG.M, "Email address");
        a.put(cG.N, "Full Name");
        a.put(cG.O, "Gender");
        a.put(cG.P, "Language");
        a.put(cG.Q, "Locale");
        a.put(cG.R, "Phone Number");
        a.put(cG.S, "Time Zone");
        a.put(cG.T, "Share the following: %s.");
        a.put(cG.U, "Use Seamless Checkout.");
        a.put(cG.V, "%s asks that you:");
        a.put(cG.W, "Share the <a href='%1$s'>payment methods</a> linked to your PayPal account.");
        a.put(cG.X, "Enable the display of your funding options to allow you to make a choice.");
        a.put(cG.Y, "<a href='%1$s'>Authorise charges</a> for future %2$s purchases paid for with PayPal. You instruct PayPal to pay all amounts requested by %3$s.");
        a.put(cG.Z, "Allow them to link and manage their loyalty card in your PayPal wallet.");
        a.put(cG.aa, "Agree to the %1$s <a href='%2$s'>privacy policy</a> and <a href='%3$s'>user agreement</a>.");
        a.put(cG.ab, "Permit them to <a href='%1$s'>request money</a> on your behalf until you withdraw consent.");
        a.put(cG.ac, "Permit them to <a href='%1$s'>send money</a> on your behalf until you withdraw consent.");
        a.put(cG.ad, "Consent");
        a.put(cG.ae, "Email");
        a.put(cG.af, "Mock Data");
        a.put(cG.ag, "Sandbox");
        a.put(cG.ah, "Expires");
        a.put(cG.ai, "<h1><strong>Payment Methods</strong></h1><p>PayPal only shares which of your payment methods are available for use.</p>");
        a.put(cG.aj, "Forgotten your password?");
        a.put(cG.ak, "From");
        a.put(cG.al, "How would you like to fund future payments to %1$s?");
        a.put(cG.am, "<h1><strong>Future Payment Agreement</strong></h1><p>Your default payment method will be used to pay for future PayPal payments from this merchant.</p><p>To cancel this agreement, log in to your PayPal account, go to <strong>Profile</strong> &gt; <strong>My Settings</strong> &gt; <strong>Log In with PayPal</strong> and remove this merchant from the list.</p><p>The Recurring Payment section of the <a href='%s'>PayPal User Agreement</a> shall apply.</p><p>To make sure payments work with your PayPal account, this app may simulate a small test transaction, but no money will be transferred for this.</p>");
        a.put(cG.an, "Internal Error");
        a.put(cG.ao, "<p>By clicking the button below, I hereby agree to the terms of the <a href='%1$s'>PayPal User Agreement</a> and declare that I am in compliance with Japanese laws and regulations, including sanctions against payments to North Korea and Iran pursuant to the <a href='%2$s'>Foreign Exchange and Foreign Trade Act</a> to complete the transaction.</p>");
        a.put(cG.ap, "Log In");
        a.put(cG.aq, "Log In with PayPal");
        a.put(cG.ar, "Log out");
        a.put(cG.as, "Log out");
        a.put(cG.at, "OK");
        a.put(cG.au, "Password");
        a.put(cG.av, "Pay After Delivery");
        a.put(cG.aw, "Pay with");
        a.put(cG.ax, "Pay with Card");
        a.put(cG.ay, "PayPal Balance");
        a.put(cG.az, "PayPal Credit");
        a.put(cG.aA, "Phone");
        a.put(cG.aB, "PIN");
        a.put(cG.aC, "Preferred Payment Method");
        a.put(cG.aD, "PayPal protects your <a href='%s'>privacy</a> and financial information.");
        a.put(cG.aE, "Processing");
        a.put(cG.aF, "Remember card");
        a.put(cG.aG, "Request Money");
        a.put(cG.aH, "<h1><strong>%s</strong></h1><p>Any relevant transaction details will be shared with the merchant.</p><p>To withdraw consent, log in at paypal.com then go to <strong>Log In with PayPal</strong> options under <strong>Profile</strong> settings and remove this merchant.</p><p>PayPal is not responsible for any actions or errors on the part of the partner.</p>");
        a.put(cG.aI, "Savings");
        a.put(cG.aJ, "Send Money");
        a.put(cG.aK, "There was a problem communicating with the PayPal servers. Please try again.");
        a.put(cG.aL, "Please log in to PayPal again.");
        a.put(cG.aM, "Session expired.");
        a.put(cG.aN, "Shipping Address");
        a.put(cG.aO, "New to PayPal? Sign Up");
        a.put(cG.aP, "Stay logged in");
        a.put(cG.aQ, "System error (%s). Please try again later.");
        a.put(cG.aR, "Try Again");
        a.put(cG.aS, "Unable to log in because two-factor authentication has been enabled for your account.");
        a.put(cG.aT, "Security Code");
        a.put(cG.aU, "Send an SMS to your phone. The 6-digit code you receive will be valid for 5 minutes.");
        a.put(cG.aV, "Sending SMS");
        a.put(cG.aW, "Enter the 6-digit security code");
        a.put(cG.aX, "Your mobile number");
        a.put(cG.aY, "Send SMS");
        a.put(cG.aZ, "Send SMS Again");
        a.put(cG.ba, "Unable to log in because two-factor authentication has been enabled for your account. Please visit the PayPal website to activate your security key.");
        a.put(cG.bb, "Payments from this device are not allowed.");
        a.put(cG.bc, "Unauthorised Device");
        a.put(cG.bd, "Payments to this merchant are not allowed (invalid clientId).");
        a.put(cG.be, "Invalid merchant");
        a.put(cG.bf, "There was a problem processing your payment. Please try again.");
        a.put(cG.bg, "Unrecognised Source");
        a.put(cG.bh, "We\u2019re Sorry");
        a.put(cG.bi, "Your Order");
        a.put(cG.bj, "Clear Card?");
        a.put(cG.bk, "Consent Failed");
        a.put(cG.bl, "Connection Failed");
        a.put(cG.bm, "Login Failed");
        a.put(cG.bn, "Log in with password");
        a.put(cG.bo, "Log in with PIN");
        a.put(cG.bp, "One moment\u2026");
        a.put(cG.bq, "Payment Failed");
        a.put(cG.br, "Scan");
        a.put(cG.bs, "Incorrect Security code. Please try again.");
        a.put(cG.bt, "Via");
        a.put(cG.bu, "System error. Please try again later.");
