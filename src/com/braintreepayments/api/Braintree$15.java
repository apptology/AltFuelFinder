    ...
    implements tenerCallback
{
    ...
    public void execute()
    {
        ...
        for (Iterator iterator = Braintree.access$1300(Braintree.this).iterator(); iterator.hasNext(); Braintree.access$1000(Braintree.this).post(new Runnable() {

        final Braintree._cls15 this$1;
