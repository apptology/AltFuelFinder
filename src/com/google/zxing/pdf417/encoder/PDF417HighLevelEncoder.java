            ...
            while (j < k1) 
            {
                ...
                } else
                {
                    ...
                    } else
                    {
                        ...
                        int j1 = determineConsecutiveBinaryCount(s, charset, j);
                        int l = j1;
                        if (j1 == 0)
                        {
                            l = 1;
                        ...
                        if (l == 1 && byte0 == 0)
                        {
                            encodeBinary(charset, j, 1, 0, stringbuilder);
                        } else
                        {
                            encodeBinary(charset, j, l, byte0, stringbuilder);
                            byte0 = 1;
                            i = 0;
                        }
                        j += l;
