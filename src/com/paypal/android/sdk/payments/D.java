...
_L5:
        obj = (G)arraylist1.get(j);
        if (i == 0)
        {
            break MISSING_BLOCK_LABEL_185;
        }
        (new StringBuilder("Matching against filter ")).append(((G) (obj)).a);
        if (!((G) (obj)).c) goto _L8; else goto _L7
_L7:
        if (i == 0);
          goto _L9
_L8:
        k = ((G) (obj)).a.match(s, s1, s2, uri, set, "ClonedLocalBroadcastManager");
