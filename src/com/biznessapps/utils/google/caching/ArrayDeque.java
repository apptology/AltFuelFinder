...
_L1:
        arraydeque.elements = (Object[])arraylist.toArray();
        return arraydeque;
    }
...
_L3:
    ...
    {
        boolean flag;
        if (!com/biznessapps/utils/google/caching/ArrayDeque.desiredAssertionStatus())
        {
            flag = true;
        } else
        {
