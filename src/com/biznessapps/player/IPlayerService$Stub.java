...
//            IPlayerService, MusicItem, PlayerState
...
_L1:
    ...
    public static IPlayerService asInterface(IBinder ibinder)
    {
        ...
        android.os.IInterface iinterface = ibinder.queryLocalInterface("com.biznessapps.player.IPlayerService");
        ...
        throws RemoteException
    {
        ...
        case 1: // '\001'
            ...
            if (parcel.readInt() != 0)
            {
                parcel = (MusicItem)MusicItem.CREATOR.reateFromParcel(parcel);
            } else
            {
                parcel = null;
            }
