    ...
    implements ommentListener
{
    ...
    public void onCommentEntered(String s)
    {
        GooglePlusSocialNetworkHandler.getInstance(activity).publishText(s, new OnSocialPublishListener() {
            ...
            final ShareComponent._cls14._cls1 this$1;
            ...
            {
                this$1 = ShareComponent._cls14._cls1.this;
                super();
            }
        });
    }
    ...
    // Unreferenced inner class com/biznessapps/common/social/ui/ShareComponent$14

/* anonymous class */
    static final class ShareComponent._cls14 extends OnCommonSocialLoginListener
    {
        ...
        {
            ShareComponent.showPostCommentDialog(activity, new ShareComponent._cls14._cls1(), text);
        }
