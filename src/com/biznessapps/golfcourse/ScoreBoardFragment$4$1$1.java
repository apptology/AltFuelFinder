    ...
    implements OnSharingCompletedListener
{
    ...
    {
        ViewUtils.showCustomToast(getApplicationContext(), getString(com.biznessapps.layout.rong));
    }
...
/* anonymous class */
    ...
    // Unreferenced inner class com/biznessapps/golfcourse/ScoreBoardFragment$4$1

/* anonymous class */
    class ScoreBoardFragment._cls4._cls1
        implements OnScoreBoardCaptureListener
    {
        ...
        public void onCaptured(Uri uri)
        {
            ...
            ShareComponent.showSharingOptionDialog(getActivity(), 239, s, ScoreBoardFragment.access$000(this$0), uri, new ScoreBoardFragment._cls4._cls1._cls1());
        }
