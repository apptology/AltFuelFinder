...
_L3:
    ...
    protected final void onCreate(Bundle bundle)
    {
        ...
        if (!r)
        {
            relativelayout.setBackgroundColor(dJ.c);
        }
        ...
        } else
        {
            ...
            dK.a(c, null, null, null, "8dip");
            dK.a(c, -2, -2);
            bundle = new LinearLayout(this);
            bundle.setOrientation(1);
            dK.a(bundle, null, "4dip", null, "4dip");
            obj1 = new TextView(this);
            dK.a(((android.view.View) (obj1)), q, null, null, null);
            ((TextView) (obj1)).setText(de.a(df.n));
            if (!r)
            {
                ((TextView) (obj1)).setTextColor(dJ.e);
            }
        ...
        dK.a(linearlayout2, null, "4dip", null, null);
        ...
        if (flag)
        {
            ...
            if (!r)
            {
                ((TextView) (obj3)).setTextColor(dJ.e);
            }
            ((TextView) (obj3)).setText(de.a(df.j));
            dK.a(((android.view.View) (obj3)), q, null, null, null);
            ...
            if (o != null)
            {
                g = new j(o.expiryMonth, o.expiryYear);
            } else
            {
                g = new j();
            }
            ...
            dK.b(((android.view.View) (obj)), null, null, bundle, null);
        } else
        {
            g = new a();
        }
        if (flag1)
        {
            ...
            if (!r)
            {
                ((TextView) (obj)).setTextColor(dJ.e);
            }
            dK.a(((android.view.View) (obj)), q, null, null, null);
            ((TextView) (obj)).setText(de.a(df.h));
            ...
            dK.b(((android.view.View) (obj3)), bundle, null, ((String) (obj1)), null);
        } else
        {
            i = new a();
        }
        if (flag2)
        {
            ...
            dK.a(((android.view.View) (obj3)), q, null, null, null);
            ((TextView) (obj3)).setText(de.a(df.i));
            ...
            dK.b(((android.view.View) (obj1)), bundle, null, null, null);
        } else
        {
            k = new a();
        }
        ...
        dK.b(linearlayout1, "16dip", "20dip", "16dip", "20dip");
        bundle = new LinearLayout(this);
        j1 = a;
        a = j1 + 1;
        bundle.setId(j1);
        ...
        dK.a(m, true, this);
        dK.a(m, "5dip", null, "5dip", null);
        dK.b(m, "8dip", "8dip", "4dip", "8dip");
        m.setTextSize(16F);
        n = new Button(this);
        obj2 = new android.widget.LinearLayout.LayoutParams(-1, -2, 1.0F);
        n.setText(de.a(df.a));
        ...
        dK.a(n, false, this);
        dK.a(n, "5dip", null, "5dip", null);
        dK.b(n, "4dip", "8dip", "8dip", "8dip");
        n.setTextSize(16F);
        ...
        U.a(this, c, de.a(df.o), "card.io - ", bundle);
    }
