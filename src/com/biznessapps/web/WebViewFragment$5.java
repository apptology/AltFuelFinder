...
class this._cls0 extends WebViewClient
{
    ...
    public void onReceivedHttpAuthRequest(final WebView webView, final HttpAuthHandler handler, final String usernameInput, final String passwordInput)
    {
        Object obj = getHoldActivity();
        if (obj != null)
        {
            usernameInput = new EditText(((Activity) (obj)).getApplicationContext());
            usernameInput.setHint(com.biznessapps.layout.t);
            passwordInput = new EditText(((Activity) (obj)).getApplicationContext());
            passwordInput.setHint(com.biznessapps.layout.t);
            ...
            (new android.app.r(getHoldActivity())).setTitle(com.biznessapps.layout.ation).setView(((View) (obj))).setCancelable(false).setPositiveButton(com.biznessapps.layout.veButton, new android.content.DialogInterface.OnClickListener() {
            ...
            }).setNegativeButton(com.biznessapps.layout.veButton, new android.content.DialogInterface.OnClickListener() {
    ...
    public boolean shouldOverrideUrlLoading(WebView webview, String s)
    {
        ...
        if (s.contains("tel:"))
        {
            ...
            {
                ViewUtils.showShortToast(getHoldActivity(), com.biznessapps.layout.l_not_available);
                return true;
            }
            return true;
        }
