    ...
    implements k
{
    ...
    public o()
    {
        ...
        a.put(cG.X, "Enable display of your funding options to allow you to make a choice.");
        a.put(cG.Y, "<a href='%1$s'>Authorize charges</a> for future %2$s purchases paid for with PayPal. You instruct PayPal to pay all amounts requested by %3$s.");
        a.put(cG.Z, "Allow them to add and manage their loyalty card in your PayPal wallet.");
        ...
        a.put(cG.aL, "Please log in again to PayPal.");
        ...
        a.put(cG.aU, "Send a text message to your phone. The 6-digit code you receive will be valid for 5 minutes.");
        a.put(cG.aV, "Sending Text");
        a.put(cG.aW, "Enter the 6-digit security code");
        a.put(cG.aX, "Your mobile number");
        a.put(cG.aY, "Send Text");
        a.put(cG.aZ, "Send Text again");
        ...
        a.put(cG.bc, "Unauthorized Device");
        ...
        a.put(cG.bg, "Unrecognized Source");
