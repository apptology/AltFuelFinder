...
class this._cls0
    implements android.view.stOrdersDetailFragment._cls8
{
    ...
    public void onClick(View view)
    {
        int i = 1;
        boolean flag = false;
        boolean flag1 = FOUtils.updateButtons(getApplicationContext(), PastOrdersDetailFragment.access$1600(PastOrdersDetailFragment.this), new Button[] {
            PastOrdersDetailFragment.access$1100(PastOrdersDetailFragment.this), PastOrdersDetailFragment.access$1200(PastOrdersDetailFragment.this), PastOrdersDetailFragment.access$1000(PastOrdersDetailFragment.this)
        });
