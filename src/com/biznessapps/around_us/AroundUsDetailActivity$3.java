...
class this._cls0
    implements android.view.ilActivity._cls3
{
    ...
    public void onClick(View view)
    {
        ...
        {
            ViewUtils.openGoogleMap(getApplicationContext(), AroundUsDetailActivity.access$000(AroundUsDetailActivity.this).tLongitude(), AroundUsDetailActivity.access$000(AroundUsDetailActivity.this).tLatitude());
        }
    }
