...
public class PaymentMethodView extends RelativeLayout
{
    public static final class PaymentType extends Enum
    {
        ...
        static 
        {
            ...
            ANDROID_PAY = new PaymentType("ANDROID_PAY", 8, com.braintreepayments.api.dropin.R.drawable.bt_android_pay, com.braintreepayments.api.dropin.R.string.bt_descriptor_android_pay, "Google Wallet");
            UNKNOWN = new PaymentType("UNKNOWN", 9, -1, com.braintreepayments.api.dropin.R.string.bt_descriptor_unknown, "unknown");
            $VALUES = (new PaymentType[] {
                VISA, MASTERCARD, DISCOVER, AMEX, JCB, DINERS, MAESTRO, PAYPAL, ANDROID_PAY, UNKNOWN
            });
        }
