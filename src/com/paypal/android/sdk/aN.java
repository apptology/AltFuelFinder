...
public final class aN
{
    ...
    public aN()
    {
        ...
        c.addRequestInterceptor(new aO(this));
        c.addResponseInterceptor(new aP(this));
        c.setHttpRequestRetryHandler(new aW(5));
    ...
    private void a(DefaultHttpClient defaulthttpclient, HttpContext httpcontext, HttpUriRequest httpurirequest, String s, aS as, Context context)
    {
        if (s != null)
        {
            httpurirequest.addHeader("Content-Type", s);
        }
        httpurirequest = e.submit(new aR(defaulthttpclient, httpcontext, httpurirequest, as));
        if (context != null)
        {
    ...
    public final void a(Context context, String s, Header aheader[], aS as)
    {
        s = new HttpDelete(s);
        if (aheader != null)
        {
        ...
        a(c, d, ((HttpUriRequest) (s)), ((String) (null)), as, context);
    }

    public final void a(Context context, String s, Header aheader[], aV av, aS as)
    {
        if (false)
        {
    ...
    public final void a(Context context, String s, Header aheader[], HttpEntity httpentity, String s1, aS as)
    {
        s = new HttpPost(s);
        if (httpentity != null)
        {
