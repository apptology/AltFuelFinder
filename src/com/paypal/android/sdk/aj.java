...
public final class aj extends ak
{
    ...
    public aj(String s, List list, Handler handler, boolean flag, SSLSocketFactory sslsocketfactory)
    {
        a = s;
        b = list;
        c = new ArrayList();
...
_L1:
        ...
        ((HttpClient) (obj)).getConnectionManager().getSchemeRegistry().register(new Scheme("https", new ap(), 443));
_L4:
        Object obj1;
...
_L9:
        ...
        com.paypal.android.sdk.d.a(((java.io.Closeable) (obj2)));
        if (obj != null)
        {
...
_L2:
        ...
        ((SchemeRegistry) (obj)).register(new Scheme("https", new ag(), 443));
_L5:
...
_L6:
        ...
        com.paypal.android.sdk.d.a(((java.io.Closeable) (obj1)));
        ((HttpClient) (obj)).getConnectionManager().shutdown();
        al.a().b(this);
        return;
        obj1;
