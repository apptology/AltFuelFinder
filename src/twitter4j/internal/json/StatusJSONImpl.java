...
_L1:
        ...
        throws TwitterException
    {
        ...
        favoriteCount = z_T4JInternalParseUtil.getLong("favorite_count", jsonobject);
...
_L2:
        if (!jsonobject.isNull("metadata"))
        {
            ...
            {
                isoLanguageCode = z_T4JInternalParseUtil.getUnescapedString("iso_language_code", ((JSONObject) (obj)));
            }
        }
