...
//            VenmoAppSwitch, AndroidPay, PayPalHelper
...
public class BraintreeApi
{
    ...
    public String collectDeviceData(Activity activity, String s, String s1)
    {
        ...
        {
            return (new StringBuilder()).append("{\"correlation_id\":\"").append(PayPalConfiguration.getClientMetadataId(activity)).append("\"}").toString();
        }
        return s;
    }
