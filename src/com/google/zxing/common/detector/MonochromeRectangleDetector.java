...
_L14:
        ...
        throws NotFoundException
    {
        ...
        int l = (int)findCornerFromCenter(j, 0, 0, k1, i, -k, 0, j1, j / 2).getY() - 1;
        ResultPoint resultpoint = findCornerFromCenter(j, -l1, 0, k1, i, 0, l, j1, i / 2);
        int i1 = (int)resultpoint.getX() - 1;
        ResultPoint resultpoint1 = findCornerFromCenter(j, l1, i1, k1, i, 0, l, j1, i / 2);
        k1 = (int)resultpoint1.getX() + 1;
        ResultPoint resultpoint2 = findCornerFromCenter(j, 0, i1, k1, i, k, l, j1, j / 2);
        j1 = (int)resultpoint2.getY();
        return (new ResultPoint[] {
            findCornerFromCenter(j, 0, i1, k1, i, -k, l, j1 + 1, j / 4), resultpoint, resultpoint1, resultpoint2
        });
    }
}
