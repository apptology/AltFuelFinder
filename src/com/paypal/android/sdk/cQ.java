...
public final class cQ
{
    ...
    public cQ(Context context)
    {
        ...
        d.setTextSize(14F);
        d.setPaintFlags(8);
        ((TableRow) (obj)).addView(d);
        d.setGravity(19);
        bu.b(d, "0dip", "4dip", "0dip", "4dip");
        bu.a(d, -2, -2);
        d.setClickable(true);
    }
