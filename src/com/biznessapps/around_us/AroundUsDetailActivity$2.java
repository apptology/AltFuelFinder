...
class this._cls0
    implements android.view.ilActivity._cls2
{
    ...
    public void onClick(View view)
    {
        ...
        {
            ViewUtils.openLinkInBrowser(getApplicationContext(), AroundUsDetailActivity.access$000(AroundUsDetailActivity.this).tLocation().getWebsite());
        }
    }
