    ...
    implements android.view.Activity._cls7
{
    ...
    public void onClick(View view)
    {
        ...
        {
            ViewUtils.openGoogleMap(getApplicationContext(), ContactsMapActivity.access$400(ContactsMapActivity.this).getLongitude(), ContactsMapActivity.access$400(ContactsMapActivity.this).getLatitude());
        }
    }
