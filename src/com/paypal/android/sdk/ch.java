...
public final class ch extends cu
{
    ...
    public ch(bs bs, c c1, String s, String s1, boolean flag, String s2, String s3, 
            String s4, String s5, JSONObject jsonobject, JSONObject jsonobject1)
    {
        ...
        if (com.paypal.android.sdk.d.d(s2))
        {
            a("PayPal-Partner-Attribution-Id", s2);
        }
        if (com.paypal.android.sdk.d.d(s3))
        {
...
_L6:
    ...
    public final String b()
    {
        ...
        jsonobject1.accumulate("device_info", com.paypal.android.sdk.d.a(bV.a().toString()));
        jsonobject1.accumulate("app_info", com.paypal.android.sdk.d.a(bS.a().toString()));
        jsonobject1.accumulate("risk_data", com.paypal.android.sdk.d.a(Z.a().c().toString()));
