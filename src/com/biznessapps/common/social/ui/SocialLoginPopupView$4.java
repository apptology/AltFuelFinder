...
class this._cls0
    implements android.view.ialLoginPopupView._cls4
{
    ...
    {
        TwitterSocialNetworkHandler.getInstance(SocialLoginPopupView.access$300(SocialLoginPopupView.this)).login(SocialLoginPopupView.access$200(SocialLoginPopupView.this));
