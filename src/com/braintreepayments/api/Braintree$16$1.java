    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/braintreepayments/api/Braintree$16

/* anonymous class */
    class Braintree._cls16
        implements Braintree.ListenerCallback
    {
        ...
        public void execute()
        {
            ...
            for (Iterator iterator = Braintree.access$1300(Braintree.this).iterator(); iterator.hasNext(); Braintree.access$1000(Braintree.this).post(errorlistener. new Braintree._cls16._cls1()))
            {
