...
label1:
        ...
        throws NotFoundException, ChecksumException, FormatException
    {
        ...
        obj = binarybitmap.getECLevel();
        if (obj != null)
        {
            map.putMetadata(ResultMetadataType.ERROR_CORRECTION_LEVEL, obj);
        }
        if (binarybitmap.hasStructuredAppend())
        {
            map.putMetadata(ResultMetadataType.STRUCTURED_APPEND_SEQUENCE, Integer.valueOf(binarybitmap.getStructuredAppendSequenceNumber()));
            map.putMetadata(ResultMetadataType.STRUCTURED_APPEND_PARITY, Integer.valueOf(binarybitmap.getStructuredAppendParity()));
        }
        return map;
    }
