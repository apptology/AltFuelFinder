    ...
    implements RequestDirector
{
    ...
    {
        this(LogFactory.getLog(org/apache/http/impl/client/DefaultRequestDirector), httprequestexecutor, clientconnectionmanager, connectionreusestrategy, connectionkeepalivestrategy, httprouteplanner, httpprocessor, httprequestretryhandler, ((RedirectStrategy) (new DefaultRedirectStrategyAdaptor(redirecthandler))), authenticationhandler, authenticationhandler1, usertokenhandler, httpparams);
    }
...
_L3:
    ...
    {
        int i;
        routedrequest = routedrequest.getRoute();
        i = 0;
_L4:
        i++;
        ...
        managedConn.open(routedrequest, httpcontext, params);
_L2:
        establishRoute(routedrequest, httpcontext);
        return;
...
_L1:
        log.warn((new StringBuilder()).append("Authentication error: ").append(((AuthenticationException) (obj)).getMessage()).toString());
        obj = httpresponse;
...
_L1:
        ...
        proxyAuthState.setAuthScope(null);
        if (!httproute.getTargetHost().equals(obj1))
        {
...
_L2:
        ...
        obj1 = targetAuthHandler.getChallenges(httpresponse, httpcontext);
        processChallenges(((Map) (obj1)), targetAuthState, targetAuthHandler, httpresponse, httpcontext);
_L4:
...
_L3:
        log.warn((new StringBuilder()).append("Authentication error: ").append(httpresponse.getMessage()).toString());
        return null;
        targetAuthState.setAuthScope(null);
        if (!proxyAuthHandler.isAuthenticationRequested(httpresponse, httpcontext))
        {
        ...
        obj = httproute.getProxyHost();
        log.debug("Proxy requested authentication");
        obj1 = proxyAuthHandler.getChallenges(httpresponse, httpcontext);
        processChallenges(((Map) (obj1)), proxyAuthState, proxyAuthHandler, httpresponse, httpcontext);
_L6:
