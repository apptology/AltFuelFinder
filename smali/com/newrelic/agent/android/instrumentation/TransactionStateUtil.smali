...
.method private static addTransactionAndErrorData(Lcom/newrelic/agent/android/instrumentation/TransactionState;Lorg/apache/http/HttpResponse;)V
    ...
    .line 219
    .local v16, "content":Ljava/io/InputStream;
    ...
    .end local v16    # "content":Ljava/io/InputStream;
    ...
    invoke-static {v2, v3, v4, v5, v0}, Lcom/newrelic/agent/android/Measurements;->addHttpError(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/util/Map;)V

    goto/16 :goto_0

    .line 222
    .restart local v16    # "content":Ljava/io/InputStream;
    :cond_5
    :try_start_1
