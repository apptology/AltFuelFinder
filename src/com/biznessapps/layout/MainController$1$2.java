...
/* anonymous class */
    class MainController._cls1 extends AsyncCallback
    {
        ...
        public void onError(String s, Throwable throwable)
        {
            ...
            if (s != null)
            {
                ViewUtils.showDialog(s, s.getString(R.string.server_connection_failure), s. new MainController._cls1._cls2(), false);
            }
        }
        ...
        public void onResult(String s)
        {
            ...
            final List tabList = cacher.getTabList();
            DataSource.getInstance().update(url, s, true);
            (new Thread(new MainController._cls1._cls1())).start();
        }
        ...
        // Unreferenced inner class com/biznessapps/layout/MainController$1$1

/* anonymous class */
        class MainController._cls1._cls1
            implements Runnable
        {
            ...
            public void run()
            {
                ...
                if (!MainController.access$000(this$0, appCode))
                {
                    ...
                    MainController.access$300(this$0, s);
