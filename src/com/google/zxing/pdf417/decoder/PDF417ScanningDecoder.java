        ...
        for (int j = 0; j < j1; j++)
        {
            ...
            if (detectionresultcolumn != null)
            {
                ...
                for (int i1 = 0; i1 < k1; i1++)
                {
                    ...
                    int l1 = codeword.getRowNumber();
                    if (l1 < 0)
                    {
                        continue;
                    }
                    if (l1 >= abarcodevalue.length)
                    {
                        throw FormatException.getFormatInstance();
                    }
                    abarcodevalue[l1][l].setValue(codeword.getValue());
                }
...
_L7:
    ...
    private static Codeword detectCodeword(BitMatrix bitmatrix, int i, int j, boolean flag, int k, int l, int i1, int j1)
    {
        ...
        {
            for (i = 0; i < bitmatrix.length / 2; i++)
            {
                l = bitmatrix[i];
    ...
    {
        if (detectionresultrowindicatorcolumn == null) goto _L2; else goto _L1
_L1:
        detectionresultrowindicatorcolumn = detectionresultrowindicatorcolumn.getBarcodeMetadata();
        if (detectionresultrowindicatorcolumn != null) goto _L3; else goto _L2
_L2:
        if (detectionresultrowindicatorcolumn1 != null) goto _L5; else goto _L4
_L4:
        return null;
_L5:
