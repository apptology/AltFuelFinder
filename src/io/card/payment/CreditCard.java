    ...
    implements Parcelable
{
    ...
    {
        return g.a(cardNumber, true, null);
    }
    ...
    public String getRedactedCardNumber()
    {
        if (cardNumber != null)
        {
            ...
            return g.a((new StringBuilder()).append(s).append(getLastFourDigitsOfCardNumber()).toString(), false, CardType.fromCardNumber(cardNumber));
        } else
        {
            return "";
        }
