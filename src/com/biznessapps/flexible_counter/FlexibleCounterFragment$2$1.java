    ...
    implements android.content.ner
{
    ...
    public void onClick(DialogInterface dialoginterface, int i)
    {
        ...
        if (FlexibleCounterFragment.access$100(_fld0) != null && !FlexibleCounterFragment.access$100(_fld0).isEmpty())
        {
            for (i = 0; i < FlexibleCounterFragment.access$100(_fld0).size(); i++)
            {
                FlexibleCounterFragment.access$100(_fld0).set(i, Integer.valueOf(0));
            }

        }
        FlexibleCounterFragment.access$200(_fld0, getActivity());
    }
...
/* anonymous class */
        ...
        implements android.view.View.OnClickListener
    {
        ...
        // Unreferenced inner class com/biznessapps/flexible_counter/FlexibleCounterFragment$2$2

/* anonymous class */
        class FlexibleCounterFragment._cls2._cls2
