...
class val.passwordInput
    implements android.content.ickListener
{

    final val.passwordInput this$1;
    ...
    {
        val$handler.proceed(val$usernameInput.getText().toString(), val$passwordInput.getText().toString());
...
/* anonymous class */
    class WebViewFragment._cls5 extends WebViewClient
    {
        ...
        public void onReceivedHttpAuthRequest(final WebView webView, final HttpAuthHandler handler, final String usernameInput, String s)
        {
...
_L3:
        ...
        // Unreferenced inner class com/biznessapps/web/WebViewFragment$5$1

/* anonymous class */
        class WebViewFragment._cls5._cls1
