...
public abstract class AsyncTask
{
    ...
    public static final class Status extends Enum
    {
        ...
        {
            return (Status)Enum.valueOf(com/biznessapps/utils/google/caching/AsyncTask$Status, s);
        }
...
_L1:
        static class _cls4
        {
            ...
            static final int $SwitchMap$com$biznessapps$utils$google$caching$AsyncTask$Status[];

            static 
            {
                $SwitchMap$com$biznessapps$utils$google$caching$AsyncTask$Status = new int[Status.values().length];
                try
                {
                    $SwitchMap$com$biznessapps$utils$google$caching$AsyncTask$Status[Status.RUNNING.ordinal()] = 1;
                }
                catch (NoSuchFieldError nosuchfielderror1) { }
                try
                {
                    $SwitchMap$com$biznessapps$utils$google$caching$AsyncTask$Status[Status.FINISHED.ordinal()] = 2;
                }
        ...
        _cls4..SwitchMap.com.biznessapps.utils.google.caching.AsyncTask.Status[mStatus.ordinal()];
...
_L4:
    ...
    static 
    {
        ...
        THREAD_POOL_EXECUTOR = new ThreadPoolExecutor(8, 128, 1L, TimeUnit.SECONDS, sPoolWorkQueue, sThreadFactory, new java.util.concurrent.ThreadPoolExecutor.DiscardOldestPolicy());
        Object obj;
        ...
        DUAL_THREAD_EXECUTOR = Executors.newFixedThreadPool(8, sThreadFactory);
